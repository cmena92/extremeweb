                        ...
                        <div class="card border-0">
                            ...
                            <div class="card-body">
                                ...
                                <?php if( ! empty( $child_cats ) ) : ?>
                                    ...
                                    <?php endforeach; ?>
                                        <li>...</li>
                                        <li class="view-all d-flex align-items-center justify-content-between"><a href="<?php echo esc_url( get_term_link( $category ) ); ?>" class="nav-link-style"><i class="czi-arrow-right-circle mr-2"></i><?php echo esc_html__( 'Todas', 'cartzilla' ); ?></a><span class="font-size-ms text-muted"><?php echo esc_html( $category->count );?></span></li>
                                    </ul>
                                <?php endif; ?>
                            </div>
                        </div>
